...
class ClassRoomsControllerTest < ActionController::TestCase
  ...
  test "should create class_room" do
    assert_difference('ClassRoom.count') do
      post :create, class_room: { course_id: @class_room.course_id, user_id: @class_room.user_id }
    end
  ...
  test "should update class_room" do
    patch :update, id: @class_room, class_room: { course_id: @class_room.course_id, user_id: @class_room.user_id }
    assert_redirected_to class_room_path(assigns(:class_room))
  end
