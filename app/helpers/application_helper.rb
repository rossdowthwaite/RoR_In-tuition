module ApplicationHelper
   ...
   def image?(file)
      file.to_s.include?(".gif") or file.to_s.include?(".png") or file.to_s.include?(".jpg") or file.to_s.include?(".jpeg") or file.to_s.include?(".JPEG")  or file.to_s.include?(".JPG")  or file.to_s.include?(".PNG") 
   end
